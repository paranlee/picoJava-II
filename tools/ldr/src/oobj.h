...
#pragma ident "@(#)oobj.h 1.6 Last modified 10/06/98 11:34:14 SMI"
...
struct fieldblock {
    ...
    /* add index for string-reuse */
    unsigned short sigIndex;
...
typedef struct ClassClass {
    ...
    /* change unused hashtable to name index */
    unsigned short           nameIndex;
    unsigned short           superNameIndex;
    ...
    unsigned short           numOfInstVars;           /* number of variable */
...
EXTERN createInternalClass(unsigned char *bytes, unsigned char *limit,
				    ClassClass *);
...
/* return the location of static_value */
