...
#pragma ident "@(#)veriuser.h 1.6 Last modified 10/06/98 11:34:26 SMI"
...
EXTERN int          tf_isetroutine PROTO_PARAMS((char *(*routine)(), char *inst));
...
EXTERN int          tf_setroutine PROTO_PARAMS((char *(*routine)()));
